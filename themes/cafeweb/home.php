<?php $v->layout("_theme"); ?>
    ...
    <article class="home_featured">
        ...
        <div class="home_featured_app">
            <img src="<?= theme("/assets/images/home-app.jpg"); ?>" alt="BKhost" title="BKhost"/>
        </div>
    </article>
    ...
    <div class="home_features">
        <section class="container content">
            <header class="home_features_header">
                <h2>O que você pode fazer com o BKhost?</h2>
    ...
    <article class="home_optin">
        <div class="home_optin_content container content">
            <header class="home_optin_content_flex">
                <h2>Cadastre-se no BKhost e comece a controlar suas contas hoje mesmo</h2>
                <p>Receber e pagar é uma tarefa comum do dia a dia, o BKhost é um gerenciador de contas simples,
                    fácil
